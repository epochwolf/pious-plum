  ...
  Plugin = (function() {
    ...
    Plugin.prototype.githubDetails = function(channel, who, message, url) {
      ...
      if (match = pathname.match(issues_url)) {
        return this.handleIssueUrl(match, channel, who, message, url);
      } else if (match = pathname.match(commits_url)) {
        return this.handleCommitUrl(match, channel, who, message, url);
      } else if (match = pathname.match(repo_url)) {
        return this.handleRepoUrl(match, channel, who, message, url);
      }
    };

    Plugin.prototype.handleIssueUrl = function(match, channel, who, message, url) {
      var issue_id, repo, user, _,
        _this = this;
    ...
    Plugin.prototype.handleCommitUrl = function(match, channel, who, message, url) {
      var repo, sha, user, _,
        _this = this;
    ...
    Plugin.prototype.handleRepoUrl = function(match, channel, who, message, url) {
      var repo, user, _,
        _this = this;
