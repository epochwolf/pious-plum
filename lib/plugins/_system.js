...
(function() {
  ...
  Plugin = (function() {
    ...
    Plugin.prototype.aboutCmd = function(channel, who, args) {
      return this.bot.say(channel, "I am a Pious Purple IRC Bot " + this.config.version + " written in Node.JS https://github.com/epochwolf/pious-plum");
    };
