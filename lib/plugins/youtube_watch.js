...
(function() {
  var Plugin, TwitterApi, dateFormat, long_video_url, short_video_url,
  ...
  short_video_url = Plugin = (function() {
    ...
    Plugin.prototype.videoDetails = function(channel, who, message, video_id) {
      ...
      return this.conn().video(video_id, function(err, data) {
        ...
        if (err) {
          ...
          return _this.bot.say(channel, "YouTube | " + title + " | " + video_length + " seconds");
        }
      });
    };
